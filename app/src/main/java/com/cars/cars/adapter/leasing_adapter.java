...
public class leasing_adapter extends RecyclerView.Adapter<leasing_adapter.MyViewHolder>  {
...
Context mContext;
  ...
  int pos =0;
    ...
    public leasing_adapter(Context mContext, List<leasing_request> serviceList) {
    ...
    @Override
    public leasing_adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.buy_row_item, parent, false);

        return new leasing_adapter.MyViewHolder(itemView);
    }


    @Override
    public void onBindViewHolder(final leasing_adapter.MyViewHolder holder, final int position) {
